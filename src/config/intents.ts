...
export const INTENTS: IntentLink[] = [
  // <custom:intents>
  { path: '/intents/besichtigung-vereinbaren', label: 'Besichtigung planen', icon: IconCalendarPlus, description: 'Interessent mit Objekt verknüpfen und Besichtigung anlegen' },
  // </custom:intents>
];
